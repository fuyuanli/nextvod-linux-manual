...
- 網樂通一台、迴紋針一隻
- 下載 ：[Win32DiskiMager][1]、[sh4twbox-0.8.1.dd.xz][2]



[1]:http://sourceforge.net/projects/win32diskimager/files/latest/download
[2]:https://sh4twbox.googlecode.com/files/sh4twbox-0.8.1.dd.xz

###開始安裝
#### **※製作安裝開機碟**
  - 1.使用7-ZIP將 **sh4twbox-0.8.1.dd.xz**解壓縮成**.dd**檔。
 ...
 **以下動作將清空隨身碟，請小心。** 
  - 3.選擇剛才所解壓縮的 **sh4twbox-0.8.1.dd**，以及剛剛準備的隨身碟（例子中是G磁碟），按下 **Write** 。
